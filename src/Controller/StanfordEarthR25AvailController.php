...
/**
 * Provide R25 available timeslots by location for a  fullcalendar js list.
 */
class StanfordEarthR25AvailController extends ControllerBase {
  ...
  /**
   * StanfordEarthR25AvailController constructor.
   */
